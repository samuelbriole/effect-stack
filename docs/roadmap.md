...
1. **Router:** the core has nested routes, layouts, ranking, and Effect loaders. React and Solid have initial first-party
   adapters. Next: Vue parity, file-routing tooling, redirects and guards, preload policy, scroll restoration, and further
...
The React and Solid adapters provide typed links, outlets, active state, lazy views, and route boundaries over the same
headless runtime. The Vue adapter should meet that behavior and inference bar before replacing its direct-Atom tracer.
