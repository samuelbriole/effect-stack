...
`@effect-web/router-react` and `@effect-web/router-solid` will appear only when accessible links, outlets, active state,
lazy views, pending/error boundaries, or SSR hydration make those packages deeper than aliases for official Atom hooks.
