// Keep this module-augmentation fixture isolated from the shared runtime-test project.
// TSTyche checks it against each supported TypeScript version.
import { MemoryHistory, type Router, type RouteTree } from "@effect-stack/router"
import { createRootRoute, createRoute, createRouter, useNavigateEffect } from "@effect-stack/router-react"
